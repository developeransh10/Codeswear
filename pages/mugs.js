// https://images-eu.ssl-images-amazon.com/images/I/31fy2JyHeSL._SX300_SY300_QL70_FMwebp_.jpg
...
const Mugs = ({products}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    return <Link passHref={true} key={item._id} href={`/product/${products[item].slug}`}><div className="lg:w-1/5 md:w-1/2 p-4 w-full cursor-pointer shadow-lg m-2">
